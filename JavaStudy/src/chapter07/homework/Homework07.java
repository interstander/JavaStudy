...
public class Homework07 {
	...
	static Student7[] stuList = new Student7[5];
	...
	private static void input() {
		...
		Student7 student = new Student7(name,scores);
	...
	private static void dummy() {
		stuList[0] = new Student7("고길동",new int[] {78,64,82});
		stuList[1] = new Student7("김길동",new int[] {85,71,64});
		stuList[2] = new Student7("이길동",new int[] {74,69,57});
		stuList[3] = new Student7("박길동",new int[] {74,77,95});
		stuList[4] = new Student7("홍길동",new int[] {68,95,84});
